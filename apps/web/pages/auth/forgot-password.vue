...
async function onSubmit() {
  ...
  try {
    ...
    error.value = msg ?? t('auth.forgotPassword.failed');
  } finally {
    loading.value = false;
  }
}
  ...
  <main class="auth">
    ...
    <section class="auth__card">
      <header class="auth__header">
        ...
        <h1 class="auth__headline">{{ t('auth.forgotPassword.heading') }}</h1>
        <p class="auth__description">{{ t('auth.forgotPassword.description') }}</p>
      </header>

      <div v-if="sent" class="auth__notice">
      ...
      <p class="auth__footer">
        <NuxtLink to="/auth/login" class="auth__link auth__link--small">
