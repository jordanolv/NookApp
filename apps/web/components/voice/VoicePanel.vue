      ...
      <div v-if="currentChannelId">
        ...
        <div class="grid grid-cols-4 gap-1.5 px-2.5 pb-2.5">
          ...
          <button
            ...
            @click="toggleDeafen"
          >
            <svg v-if="!isDeafened" width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
              <path
          ...
          <button
            ...
            @click="toggleCamera"
          >
            <svg v-if="!isCameraOn" width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
              <path
            ...
            <span class="text-[9px] leading-none font-medium">{{ t('voice.labels.camera') }}</span>
          </button>
